...
def write_sheet(writer, data, sheet_name, tipe):
    ...
    data.to_excel(writer, index=False, sheet_name=sheet_name, startrow=12)
    ...
    ws['A8'] = "Broker"
    ws['B8'] = ":"
    ws['C8'] = "ALL" if "ALL" in selected_broker else ", ".join(selected_broker)
